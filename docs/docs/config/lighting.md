...
| `ZMK_RGB_UNDERGLOW_BATTERY_CRITICALLY_LOW_THRESHOLD` | int  | Battery level considered critical in percent (0-100)                     | 5       |
| `ZMK_RGB_UNDERGLOW_BATTERY_LOW_THRESHOLD`            | int  | Battery level considered low in percent (0-100)                          | 15      |
| `ZMK_RGB_UNDERGLOW_BLE_STATUS`                       | bool | Display blutooth connction status on startup and when connection changes | n       |
