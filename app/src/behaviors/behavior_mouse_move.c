...
static int on_keymap_binding_pressed(struct zmk_behavior_binding *binding,
    ...
    return raise_zmk_mouse_move_state_changed_from_encoded(binding->param1, true, event.timestamp);
}
...
static int on_keymap_binding_released(struct zmk_behavior_binding *binding,
    ...
    return raise_zmk_mouse_move_state_changed_from_encoded(0, false, event.timestamp);
}
